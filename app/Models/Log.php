...
class Log extends Model
{
    ...
    // Company Phone Number Management
    public const ACTION_CREATE_COMPANY_PHONE = 67;
    public const ACTION_UPDATE_COMPANY_PHONE = 68;
    public const ACTION_DELETE_COMPANY_PHONE = 69;
    public const ACTION_SHOW_COMPANY_PHONE = 70;
    public const ACTION_FORCE_DELETE_COMPANY_PHONE = 71;
    public const ACTION_RESTORE_COMPANY_PHONE = 72;
    public const ACTION_IMPORT_COMPANY_PHONE = 73;
    ...
    // Bill Of Material Item (BOMItem) Management
    public const ACTION_CREATE_BILL_OF_MATERIAL_ITEM = 130;
    public const ACTION_UPDATE_BILL_OF_MATERIAL_ITEM = 131;
    public const ACTION_DELETE_BILL_OF_MATERIAL_ITEM = 132;
    public const ACTION_SHOW_BILL_OF_MATERIAL_ITEM = 133;
    public const ACTION_FORCE_DELETE_BILL_OF_MATERIAL_ITEM = 134;
    public const ACTION_RESTORE_BILL_OF_MATERIAL_ITEM = 135;
    public const ACTION_IMPORT_BILL_OF_MATERIAL_ITEM = 136;
