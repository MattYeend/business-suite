...
class UpdatePartRequest extends FormRequest
{
    ...
    protected function skuRules(): array
    {
        return [
            ...
            'string',
            'max:255',
            Rule::unique('parts', 'sku')->ignore($this->getPartId()),
        ];
    }
    ...
    protected function partNumberRules(): array
    {
        return [
            ...
            'string',
            'max:255',
            Rule::unique('parts', 'part_number')->ignore($this->getPartId()),
        ];
    }
    ...
    protected function barcodeRules(): array
    {
        return [
            ...
            'string',
            'max:255',
            Rule::unique('parts', 'barcode')->ignore($this->getPartId()),
        ];
    }
    ...
    /**
     * Get the part ID from the route.
     *
     * @return mixed
     */
    protected function getPartId(): mixed
    {
        $route = $this->route('part');
