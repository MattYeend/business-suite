...
class CompanyAddressQueryService
{
    public function __construct(
        ...
        protected CompanyAddressFilterService $filterService,
        protected CompanyAddressFormatterService $formatterService
    ) {
    }

    /**
     * Get paginated company addresses with filters.
     *
     * @param  array $filters
     *
     * @return array
    ...
    {
        $address = $this->findCompanyAddress($id, $withTrashed);
    ...
    protected function getPermissions(): array
    {
        ...
        return [
            'permissions_meta' => [
                'can_create' => $user->can('create', CompanyAddress::class),
                'can_view_any' => $user->can('viewAny', CompanyAddress::class),
            ],
        ];
    }
     ...
     */
    private function findCompanyAddress(
        int $id,
