...
class ProductQueryService
{
    ...
    public function __construct(
        ...
        protected ProductTrashFilterService $trashFilterService,
        protected ProductFilterService $filterService,
        protected ProductFormatterService $formatterService
    ) {
    }
    ...
    {
        $product = $this->findCompany($id, $withTrashed);

        return array_merge(
            ['product' => $this->formatterService->format($product)],
            $this->getPermissions(),
            $this->baseData(),
        );
    }
    ...
    protected function getPermissions(): array
    {
        ...
        return [
            'permissions_meta' => [
                'can_create' => $user->can('create', Product::class),
                'can_view_any' => $user->can('viewAny', Product::class),
            ],
        ];
    }
    ...
    /**
     * Find a product product by ID with optional trashed records.
     *
     * @param  int $id
     * @param  bool $withTrashed
     *
